...
import { haveState , addStateTo , stateValue, pushToState , deleteStateFrom } from "../../core/state/State"
import { getEntry, loseEntry } from "../../core/state/Entry"
import { createImpact, impactToObject, loseImpactFrom } from "../../core/state/Impact"
import { loseCharacteristic, runCharaFunction } from "../../core/objects/Characteristic"
